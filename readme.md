...
This is a personal fork of [QMK Firmware](https://github.com/qmk/qmk_firmware)
containing my custom **minimal-code** keymap for the Lily58 split keyboard.
...
This fork is based on [qmk/qmk_firmware](https://github.com/qmk/qmk_firmware).
